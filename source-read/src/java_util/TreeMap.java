...
public class TreeMap<K, V> extends AbstractMap<K, V> implements NavigableMap<K, V>, Cloneable, Serializable {
    ...
    /**
     * 将指定集合的所有键值对插入到该集合中，按key自然排序。前提是key支持比较
     *
     * @param m 指定的集合
     * @throws ClassCastException   如果key不能参与比较
     ...
     * @return 返回集合中是否包含key
     * @throws ClassCastException   如果key不能参与比较
     * @throws NullPointerException 如果不支持key为null，而key恰好为null
     */
    ...
    /**
     * @throws ClassCastException   如果key不能参与比较
     * @throws NullPointerException 如果key不能为null，而指定的key恰好为null
     */
     ...
     * 获取指定key对应的entry；
     * <p>
     * 如果不存在这样的条目，则返回大于指定键的最小键的条目；
     * <p>
     * 如果不存在这样的条目（即树中的最大键小于指定键），则返回 {@code null}。
     */
